...
public class BoardController {
	...
	public String openBoardWrite(Model model,Principal principal) throws Exception{
	...
	public String updateBoard(BoardDto board, Principal principal) throws Exception{
		board.setUpdaterId(principal.getName());
